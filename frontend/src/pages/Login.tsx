    ...
    <div className="min-h-screen flex w-full bg-gray-50 dark:bg-[#0A0F1C]">
        ...
        <div className="relative z-10 p-12 max-w-lg">
          ...
          >
            <h1 className="text-5xl font-extrabold leading-tight mb-6">
              Master your next <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">tech interview.</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 leading-relaxed">
              Practice mock interviews with our advanced AI, get instant resume ATS feedback, master coding challenges, and land your dream job faster. Everything you need to succeed, all in one place.
            </p>
            ...
            <div className="flex items-center space-x-4 text-sm font-medium text-gray-300 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full p-2 pr-6 w-fit">
              ...
              <span>Over 10,000+ mock interviews completed</span>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 relative">
        <motion.div 
          ...
          className="max-w-md w-full bg-white dark:bg-card-dark rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] p-8 sm:p-10 border border-gray-100 dark:border-gray-800"
        >
        ...
        <motion.div 
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="absolute bottom-6 w-full text-center px-4 hidden sm:block"
        >
